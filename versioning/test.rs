items: [(1, VersionVariant { version_number: 1, variant_ident: Ident { ident: "V1", span: #0 bytes(484..486) }, variant_ty: Type::Path { qself: None, path: Path { leading_colon: None, segments: [PathSegment { ident: Ident { ident: "MyStructV1", span: #0 bytes(487..497) }, arguments: PathArguments::None }] } }, latest: false }), (2, VersionVariant { version_number: 2, variant_ident: Ident { ident: "V2", span: #0 bytes(518..520) }, variant_ty: Type::Path { qself: None, path: Path { leading_colon: None, segments: [PathSegment { ident: Ident { ident: "MyStructV2", span: #0 bytes(521..531) }, arguments: PathArguments::None }] } }, latest: true })]
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for MyStructVersion {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            #[doc(hidden)]
            const VARIANTS: &'static [&'static str] = &["V1", "V2"];
...
pub fn upgrade_my_struct(value: MyStructVersion) -> MyStructV2 {
    match value {
        MyStructVersion::V1(v1) => v1.upgrade(),
        MyStructVersion::V2(v2) => v2,
    }
}
